...
'End Function
'
'Public Function utils.existsFile(ByVal pathFile As String) As Boolean
'
'    Dim fso As New Scripting.FileSystemObject
'    utils.existsFile = fso.FileExists(pathFile)
'    Set fso = Nothing
'
'End Function
'
...
'End Function
'
'Public Function utils.URLEncode(ByVal url As String) As String
'
